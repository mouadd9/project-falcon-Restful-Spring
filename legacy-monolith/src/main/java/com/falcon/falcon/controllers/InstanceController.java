...
//         // This line BLOCKS until the entire operation completes (30-60 seconds)
//         CompletableFuture<CreateInstanceResponse> instanceFuture = instanceService.createAndProvisionInstance(roomId, userId);
//         // Spring automatically waits for CompletableFuture to resolve
//         // HTTP response is sent only after AWS operation completes
